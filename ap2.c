...
//list+1의 주소값을 출력한다. 이때 list에+1는 list[1]를 의미한다.
    printf("address of list + 2 \t= %p\n",list+2); 
//list+2의 주소값을 출력한다. 이때 list에+2는 list[2]를 의미한다.
    printf("address of list + 3 \t= %p\n",list+3); 
//list+3의 주소값을 출력한다. 이때 list에+3는 list[3]를 의미한다.
    printf("address of list + 4 \t= %p\n",list+4); 
//list+4의 주소값을 출력한다. 이때 list에+4는 list[4]를 의미한다.
    printf("address of list[4] \t= %p\n",&list[4]); 
//list[4]의 주소값을 출력한다. 
